...
| `Unpinned` | `Boolean` | Optional | - | Boolean getUnpinned() | setUnpinned(Boolean unpinned) |
...
| `Posters` | [`List<Poster6>`](../../doc/models/poster-6.md) | Optional | - | List<Poster6> getPosters() | setPosters(List<Poster6> posters) |
...
import com.example.discourse.models.Topic7;
import java.io.IOException;

Topic7 topic7 = new Topic7.Builder()
    .id(162)
    .title("title2")
