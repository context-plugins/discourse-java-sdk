...
| `Participants` | `List<Object>` | Optional | - | List<Object> getParticipants() | setParticipants(List<Object> participants) |
...
import com.example.discourse.models.Topic3;
import java.io.IOException;

Topic3 topic3 = new Topic3.Builder()
    .id(212)
    .title("title8")
