...
| `TopicList` | [`TopicList4`](../../doc/models/topic-list-4.md) | Optional | - | TopicList4 getTopicList() | setTopicList(TopicList4 topicList) |
...
LatestJsonResponse latestJsonResponse = new LatestJsonResponse.Builder()
    .users(Arrays.asList(
        new User2.Builder()
            .id(58)
            .username("username4")
    ...
    .topicList(new TopicList4.Builder()
